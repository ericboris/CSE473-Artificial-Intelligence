...
class TestA0Functions(unittest.TestCase):
    ...
    def test_is_multiple_of_9(self):
        ...
        self._test_function_on_cases(a0.is_multiple_of_9, test_cases)
    ...
    def test_next_prime(self):
        ...
        self._test_function_on_cases(a0.next_prime, test_cases, test_type=True,
                                     expect_type=int)

    def test_quadratic_roots(self):
        """Provided tests for quadratic_roots in starter code."""
        roots = a0.quadratic_roots(1, 4, -21)
        ...
        self.assertEqual(a0.quadratic_roots(1, 1, 1), "complex")
    ...
    def test_double_consonants(self):
        ...
        self._test_function_on_cases(a0.double_consonants, test_cases)
