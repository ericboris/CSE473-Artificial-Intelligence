...
RAD = 20 # Radius of node circles on the screen, in pixels. Also used elsewhere,
...
def show_entire_trellis(S, observation_sequence, width=800, height=500, has_initial_state=False):
